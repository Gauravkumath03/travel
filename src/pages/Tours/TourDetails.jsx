...
function TourDetails() {
  ...
  return (
    <>
    <Breadcrumbs title={TourDetails.title} pagename=<NavLink to='/tours'>Tours</NavLink> />
                ...
                <Tab.Pane eventKey="4">
                  <div className="tour_details">
                    ...
                    <iframe
                      title="map"
                      className="pt-4"
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3619.41070957819!2d74.6447798752245!3d24.883968577913954!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3968a0f41033ea0d%3A0x4ef923088d726382!2sChittorgarh%20Fort!5e0!3m2!1sen!2sin!4v1728813559845!5m2!1sen!2sin"
                      width="100%"
                      height="450"
                      allowFullScreen=""
                      loading="lazy"
                  ...
                  <Card className="rounded-3 p-2 shadow-sm mb-4 price-info">
                    <Card.Body>
                      <Stack direction="horizontal" gap={2}>
                        ...
                        <FontAwesomeIcon icon={faIndianRupeeSign} style={{color: "#74C0FC",}} />289.00
                        </h1>
